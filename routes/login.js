...
const fs = require('fs');
const rsa = new RSA();
var rsaPublic = fs.readFileSync("/home/ligeomal/workspace/ooc_backend/ooc_bcknd_local/public/rsa/public.pem");
var rsaPrivate = fs.readFileSync('/home/ligeomal/workspace/ooc_backend/ooc_bcknd_local/public/rsa/private.pem');
